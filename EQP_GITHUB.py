...
quantidade_questoes_abertas = st.number_input("5. Quantidade de questões abertas", min_value=0, value=3)
quantidade_questoes_interpretacao = st.number_input("6. Quantidade de questões de interpretação textual", min_value=0, value=5)
quantidade_questoes_sentence_completion = st.number_input("7. Quantidade de questões sentence completion (somente inglês)", min_value=0, value=3)
quantidade_questoes_dissertativas = st.number_input("8. Quantidade de questões dissertativas", min_value=0, value=1)
quantidade_linhas_questoes_dissertativas = st.number_input("  8.1 Quantidade mínima de linhas nas questões dissertativas", min_value=0, value=10)
