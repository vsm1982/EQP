...
obs = st.text_area("Observações Adicionais", height=150)
...
quantidade_questoes_vf = st.number_input("4. Quantidade de questões do tipo Verdadeiro ou Falso", min_value=0, value=0)
quantidade_questoes_abertas = st.number_input("5. Quantidade de questões abertas", min_value=0, value=0)
quantidade_questoes_interpretacao = st.number_input("6. Quantidade de questões de interpretação textual", min_value=0, value=0)
quantidade_questoes_sentence_completion = st.number_input("7. Quantidade de questões sentence completion (somente inglês)", min_value=0, value=0)
